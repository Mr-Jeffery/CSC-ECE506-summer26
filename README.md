...
- Start early and post your questions on Piazza.

---

## 8. Resource Information

- Log on to `remote.csc.ncsu.edu` using PuTTY or MobaXterm:

  ```
  ssh <unityID>@remote.csc.ncsu.edu
  ```

- Transfer your code with `scp`:

  ```
  scp -r <source_path> <unityID>@remote.csc.ncsu.edu:<dest_path>
  ```

- Reference for MESI and Dragon: Solihin, *Fundamentals of Parallel Multicore Architecture*, Chapter 8 (Bus-Based Cache Coherence).
