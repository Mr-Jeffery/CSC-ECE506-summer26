...
enum statistic_e {
    ...
    /// @brief A received BusUpd whose line was read again before being evicted (Dragon)
    UsefulBusUpdate,
...
struct cache_line {
    ...
    state_e state;
    /// @brief Whether this line holds a BusUpd value not yet consumed by a local read (Dragon)
    bool updated;
